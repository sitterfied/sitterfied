...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sitter.highest_education'
        db.alter_column(u'app_sitter', 'highest_education', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Sitter.major'
        db.alter_column(u'app_sitter', 'major', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Sitter.occupation'
        db.alter_column(u'app_sitter', 'occupation', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Sitter.extra_exp'
        db.alter_column(u'app_sitter', 'extra_exp', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Sitter.last_school'
        db.alter_column(u'app_sitter', 'last_school', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Sitter.highest_education'
        db.alter_column(u'app_sitter', 'highest_education', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Sitter.major'
        db.alter_column(u'app_sitter', 'major', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Sitter.occupation'
        db.alter_column(u'app_sitter', 'occupation', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Sitter.extra_exp'
        db.alter_column(u'app_sitter', 'extra_exp', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Sitter.last_school'
        db.alter_column(u'app_sitter', 'last_school', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
