...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Parent.physician_contact'
        db.alter_column(u'app_parent', 'physician_contact_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['app.Contact']))

        # Changing field 'Parent.emergency_contact'
        db.alter_column(u'app_parent', 'emergency_contact_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['app.Contact']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Parent.physician_contact'
        raise RuntimeError("Cannot reverse this migration. 'Parent.physician_contact' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Parent.emergency_contact'
        raise RuntimeError("Cannot reverse this migration. 'Parent.emergency_contact' and its values cannot be restored.")
