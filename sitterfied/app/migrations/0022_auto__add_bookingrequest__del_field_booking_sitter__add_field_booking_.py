...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BookingRequest'
        db.create_table(u'app_bookingrequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('booking', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Booking'])),
            ('sitter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Sitter'])),
            ('sitter_accepted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('rate', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal(u'app', ['BookingRequest'])

        # Deleting field 'Booking.sitter'
        db.delete_column(u'app_booking', 'sitter_id')

        # Adding field 'Booking.booking_type'
        db.add_column(u'app_booking', 'booking_type',
                      self.gf('django.db.models.fields.CharField')(default='Job', max_length=10),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting model 'BookingRequest'
        db.delete_table(u'app_bookingrequest')


        # User chose to not deal with backwards NULL issues for 'Booking.sitter'
        raise RuntimeError("Cannot reverse this migration. 'Booking.sitter' and its values cannot be restored.")
        # Deleting field 'Booking.booking_type'
        db.delete_column(u'app_booking', 'booking_type')


        # User chose to not deal with backwards NULL issues for 'Booking.emergency_phone'
        raise RuntimeError("Cannot reverse this migration. 'Booking.emergency_phone' and its values cannot be restored.")
