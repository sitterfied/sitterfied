...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmailSettings.user'
        db.add_column(u'app_emailsettings', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['app.User'], unique=True),
                      keep_default=False)

        # Adding field 'MobileSettings.user'
        db.add_column(u'app_mobilesettings', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['app.User'], unique=True),
                      keep_default=False)

        # Deleting field 'User.email_settings'
        db.delete_column(u'app_user', 'email_settings_id')

        # Deleting field 'User.membership_status'
        db.delete_column(u'app_user', 'membership_status_id')

        # Deleting field 'User.mobile_settings'
        db.delete_column(u'app_user', 'mobile_settings_id')

        # Adding field 'User.status'
        db.add_column(u'app_user', 'status',
                      self.gf('django.db.models.fields.CharField')(default='trial', max_length=10),
                      keep_default=False)

        # Adding field 'User.membership_exp_date'
        db.add_column(u'app_user', 'membership_exp_date',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EmailSettings.user'
        db.delete_column(u'app_emailsettings', 'user_id')

        # Deleting field 'MobileSettings.user'
        db.delete_column(u'app_mobilesettings', 'user_id')


        # User chose to not deal with backwards NULL issues for 'User.email_settings'
        raise RuntimeError("Cannot reverse this migration. 'User.email_settings' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'User.membership_status'
        raise RuntimeError("Cannot reverse this migration. 'User.membership_status' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'User.mobile_settings'
        raise RuntimeError("Cannot reverse this migration. 'User.mobile_settings' and its values cannot be restored.")
        # Deleting field 'User.status'
        db.delete_column(u'app_user', 'status')

        # Deleting field 'User.membership_exp_date'
        db.delete_column(u'app_user', 'membership_exp_date')
