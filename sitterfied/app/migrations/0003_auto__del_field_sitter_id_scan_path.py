...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sitter.id_scan_path'
        db.delete_column(u'app_sitter', 'id_scan_path')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Sitter.id_scan_path'
        raise RuntimeError("Cannot reverse this migration. 'Sitter.id_scan_path' and its values cannot be restored.")
