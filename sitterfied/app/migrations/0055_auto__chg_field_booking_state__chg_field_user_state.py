...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'app_booking', 'state', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'User.state'
        db.alter_column(u'app_user', 'state', self.gf('django.db.models.fields.CharField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'Booking.state'
        db.alter_column(u'app_booking', 'state', self.gf('django_localflavor_us.models.USStateField')(max_length=2))

        # Changing field 'User.state'
        db.alter_column(u'app_user', 'state', self.gf('django_localflavor_us.models.USStateField')(max_length=2))
