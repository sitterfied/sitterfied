...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Parent.payment_method'
        db.add_column(u'app_parent', 'payment_method',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)

        # Adding field 'Parent.billing_address1'
        db.add_column(u'app_parent', 'billing_address1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Parent.billing_address2'
        db.add_column(u'app_parent', 'billing_address2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'Sitter.travel_distance'
        db.alter_column(u'app_sitter', 'travel_distance', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):
        # Deleting field 'Parent.payment_method'
        db.delete_column(u'app_parent', 'payment_method')

        # Deleting field 'Parent.billing_address1'
        db.delete_column(u'app_parent', 'billing_address1')

        # Deleting field 'Parent.billing_address2'
        db.delete_column(u'app_parent', 'billing_address2')


        # Changing field 'Sitter.travel_distance'
        db.alter_column(u'app_sitter', 'travel_distance', self.gf('django.db.models.fields.IntegerField')())
