...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.cell'
        db.alter_column(u'app_user', 'cell', self.gf('django.db.models.fields.CharField')(max_length=12))

    def backwards(self, orm):

        # Changing field 'User.cell'
        db.alter_column(u'app_user', 'cell', self.gf('django.db.models.fields.CharField')(max_length=9))
