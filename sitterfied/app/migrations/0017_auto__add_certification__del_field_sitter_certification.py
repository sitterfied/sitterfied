...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_certification', (
            ...
            ('certification', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal(u'app', ['Certification'])

        # Deleting field 'Sitter.certification'
        db.delete_column(u'app_sitter', 'certification')

        # Adding M2M table for field certifications on 'Sitter'
        db.create_table(u'app_sitter_certifications', (
        ...
        db.create_unique(u'app_sitter_certifications', ['sitter_id', 'certification_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Sitter.certification'
        db.add_column(u'app_sitter', 'certification',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Removing M2M table for field certifications on 'Sitter'
        db.delete_table('app_sitter_certifications')
