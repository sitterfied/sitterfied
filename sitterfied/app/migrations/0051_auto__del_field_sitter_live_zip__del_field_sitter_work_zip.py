...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sitter.live_zip'
        db.delete_column(u'app_sitter', 'live_zip')

        # Deleting field 'Sitter.work_zip'
        db.delete_column(u'app_sitter', 'work_zip')


    def backwards(self, orm):
        # Adding field 'Sitter.live_zip'
        db.add_column(u'app_sitter', 'live_zip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=9, blank=True),
                      keep_default=False)

        # Adding field 'Sitter.work_zip'
        db.add_column(u'app_sitter', 'work_zip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=9, blank=True),
                      keep_default=False)
