...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Settings.user'
        db.add_column(u'app_settings', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['app.User'], unique=True, null=True),
                      keep_default=False)

        # Deleting field 'User.settings'
        db.delete_column(u'app_user', 'settings_id')


    def backwards(self, orm):
        # Deleting field 'Settings.user'
        db.delete_column(u'app_settings', 'user_id')

        # Adding field 'User.settings'
        db.add_column(u'app_user', 'settings',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['app.Settings'], unique=True, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'app.user': {
            ...
            'sitter_groups': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['app.Group']", 'symmetrical': 'False'}),
