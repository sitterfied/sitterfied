...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Settings.new_reference_request'
        db.delete_column(u'app_settings', 'new_reference_request')

        # Deleting field 'Settings.message_received'
        db.delete_column(u'app_settings', 'message_received')

        # Deleting field 'Settings.new_review'
        db.delete_column(u'app_settings', 'new_review')

        # Deleting field 'Settings.new_reference'
        db.delete_column(u'app_settings', 'new_reference')

        # Deleting field 'Settings.booking_accepted_denied'
        db.delete_column(u'app_settings', 'booking_accepted_denied')

        # Deleting field 'Settings.upcoming_booking'
        db.delete_column(u'app_settings', 'upcoming_booking')

        # Adding field 'Settings.mobile_booking_accepted_denied'
        db.add_column(u'app_settings', 'mobile_booking_accepted_denied',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.mobile_new_review'
        db.add_column(u'app_settings', 'mobile_new_review',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.mobile_booking_request'
        db.add_column(u'app_settings', 'mobile_booking_request',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.mobile_friend_joined'
        db.add_column(u'app_settings', 'mobile_friend_joined',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.mobile_groups_added_network'
        db.add_column(u'app_settings', 'mobile_groups_added_network',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.mobile_upcoming_booking_remind'
        db.add_column(u'app_settings', 'mobile_upcoming_booking_remind',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.email_booking_accepted_denied'
        db.add_column(u'app_settings', 'email_booking_accepted_denied',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.email_new_review'
        db.add_column(u'app_settings', 'email_new_review',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.email_booking_request'
        db.add_column(u'app_settings', 'email_booking_request',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.email_friend_joined'
        db.add_column(u'app_settings', 'email_friend_joined',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.email_groups_added_network'
        db.add_column(u'app_settings', 'email_groups_added_network',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.email_upcoming_booking_remind'
        db.add_column(u'app_settings', 'email_upcoming_booking_remind',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.email_news'
        db.add_column(u'app_settings', 'email_news',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.email_blog'
        db.add_column(u'app_settings', 'email_blog',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Settings.new_reference_request'
        db.add_column(u'app_settings', 'new_reference_request',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.message_received'
        db.add_column(u'app_settings', 'message_received',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.new_review'
        db.add_column(u'app_settings', 'new_review',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.new_reference'
        db.add_column(u'app_settings', 'new_reference',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.booking_accepted_denied'
        db.add_column(u'app_settings', 'booking_accepted_denied',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Settings.upcoming_booking'
        db.add_column(u'app_settings', 'upcoming_booking',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Settings.mobile_booking_accepted_denied'
        db.delete_column(u'app_settings', 'mobile_booking_accepted_denied')

        # Deleting field 'Settings.mobile_new_review'
        db.delete_column(u'app_settings', 'mobile_new_review')

        # Deleting field 'Settings.mobile_booking_request'
        db.delete_column(u'app_settings', 'mobile_booking_request')

        # Deleting field 'Settings.mobile_friend_joined'
        db.delete_column(u'app_settings', 'mobile_friend_joined')

        # Deleting field 'Settings.mobile_groups_added_network'
        db.delete_column(u'app_settings', 'mobile_groups_added_network')

        # Deleting field 'Settings.mobile_upcoming_booking_remind'
        db.delete_column(u'app_settings', 'mobile_upcoming_booking_remind')

        # Deleting field 'Settings.email_booking_accepted_denied'
        db.delete_column(u'app_settings', 'email_booking_accepted_denied')

        # Deleting field 'Settings.email_new_review'
        db.delete_column(u'app_settings', 'email_new_review')

        # Deleting field 'Settings.email_booking_request'
        db.delete_column(u'app_settings', 'email_booking_request')

        # Deleting field 'Settings.email_friend_joined'
        db.delete_column(u'app_settings', 'email_friend_joined')

        # Deleting field 'Settings.email_groups_added_network'
        db.delete_column(u'app_settings', 'email_groups_added_network')

        # Deleting field 'Settings.email_upcoming_booking_remind'
        db.delete_column(u'app_settings', 'email_upcoming_booking_remind')

        # Deleting field 'Settings.email_news'
        db.delete_column(u'app_settings', 'email_news')

        # Deleting field 'Settings.email_blog'
        db.delete_column(u'app_settings', 'email_blog')
    ...
    models = {
        ...
        u'app.user': {
            ...
            'settings': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['app.Settings']", 'unique': 'True', 'null': 'True'}),
