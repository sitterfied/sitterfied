...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'app_address', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['app.User']),
                      keep_default=False)

        # Deleting field 'User.home_address'
        db.delete_column(u'app_user', 'home_address_id')


    def backwards(self, orm):
        # Deleting field 'Address.user'
        db.delete_column(u'app_address', 'user_id')


        # User chose to not deal with backwards NULL issues for 'User.home_address'
        raise RuntimeError("Cannot reverse this migration. 'User.home_address' and its values cannot be restored.")
