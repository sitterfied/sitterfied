...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.facebook_token'
        db.add_column(u'app_user', 'facebook_token',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True),
                      keep_default=False)

        # Adding field 'User.facebook_id'
        db.add_column(u'app_user', 'facebook_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.facebook_token'
        db.delete_column(u'app_user', 'facebook_token')

        # Deleting field 'User.facebook_id'
        db.delete_column(u'app_user', 'facebook_id')
    ...
    models = {
        ...
        u'app.user': {
            ...
            'facebook_token': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True'}),
