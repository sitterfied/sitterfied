...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'app_booking', 'emergency_phone', self.gf('django.db.models.fields.CharField')(max_length=12))

    def backwards(self, orm):

        # Changing field 'Booking.emergency_phone'
        db.alter_column(u'app_booking', 'emergency_phone', self.gf('django.db.models.fields.CharField')(max_length=10))
