...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SitterReview.rating'
        db.delete_column(u'app_sitterreview', 'rating')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SitterReview.rating'
        raise RuntimeError("Cannot reverse this migration. 'SitterReview.rating' and its values cannot be restored.")
