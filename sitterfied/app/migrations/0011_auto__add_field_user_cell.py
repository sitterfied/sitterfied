...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.cell'
        db.add_column(u'app_user', 'cell',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=9, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.cell'
        db.delete_column(u'app_user', 'cell')
    ...
    models = {
        ...
        u'app.user': {
            ...
            'cell': ('django.db.models.fields.CharField', [], {'max_length': '9', 'blank': 'True'}),
