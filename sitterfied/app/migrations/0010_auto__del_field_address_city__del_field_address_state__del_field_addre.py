...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'app_address', 'city')

        # Deleting field 'Address.state'
        db.delete_column(u'app_address', 'state')

        # Deleting field 'Address.zip'
        db.delete_column(u'app_address', 'zip')

        # Deleting field 'Address.address1'
        db.delete_column(u'app_address', 'address1')

        # Deleting field 'Address.address2'
        db.delete_column(u'app_address', 'address2')

        # Adding field 'User.address1'
        db.add_column(u'app_user', 'address1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'User.address2'
        db.add_column(u'app_user', 'address2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'User.city'
        db.add_column(u'app_user', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'User.state'
        db.add_column(u'app_user', 'state',
                      self.gf('django_localflavor_us.models.USStateField')(default='', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'User.zip'
        db.add_column(u'app_user', 'zip',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Address.zip'
        raise RuntimeError("Cannot reverse this migration. 'Address.zip' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Address.address1'
        raise RuntimeError("Cannot reverse this migration. 'Address.address1' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Address.address2'
        raise RuntimeError("Cannot reverse this migration. 'Address.address2' and its values cannot be restored.")
        # Deleting field 'User.address1'
        db.delete_column(u'app_user', 'address1')

        # Deleting field 'User.address2'
        db.delete_column(u'app_user', 'address2')

        # Deleting field 'User.city'
        db.delete_column(u'app_user', 'city')

        # Deleting field 'User.state'
        db.delete_column(u'app_user', 'state')

        # Deleting field 'User.zip'
        db.delete_column(u'app_user', 'zip')
