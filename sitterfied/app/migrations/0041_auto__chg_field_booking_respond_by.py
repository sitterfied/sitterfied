...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Booking.respond_by'
        db.alter_column(u'app_booking', 'respond_by', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Booking.respond_by'
        raise RuntimeError("Cannot reverse this migration. 'Booking.respond_by' and its values cannot be restored.")
