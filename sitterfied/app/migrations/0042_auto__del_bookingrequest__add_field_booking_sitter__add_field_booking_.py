...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Booking.sitter'
        db.add_column(u'app_booking', 'sitter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, related_name='bookings', to=orm['app.Sitter']),
                      keep_default=False)

        # Adding field 'Booking.rate'
        db.add_column(u'app_booking', 'rate',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'Booking.sitter_accepted'
        db.add_column(u'app_booking', 'sitter_accepted',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'app_bookingrequest', (
            ...
            ('sitter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='booking_requests', to=orm['app.Sitter'])),
        ...
        # Deleting field 'Booking.rate'
        db.delete_column(u'app_booking', 'rate')

        # Deleting field 'Booking.sitter_accepted'
        db.delete_column(u'app_booking', 'sitter_accepted')
