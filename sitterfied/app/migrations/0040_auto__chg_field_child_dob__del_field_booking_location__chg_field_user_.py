...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'app_child', 'dob', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Deleting field 'Booking.location'
        db.delete_column(u'app_booking', 'location_id')


        # Changing field 'User.membership_exp_date'
        db.alter_column(u'app_user', 'membership_exp_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Sitter.dob'
        db.alter_column(u'app_sitter', 'dob', self.gf('django.db.models.fields.DateTimeField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.membership_exp_date'
        db.alter_column(u'app_user', 'membership_exp_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Sitter.dob'
        db.alter_column(u'app_sitter', 'dob', self.gf('django.db.models.fields.DateField')())
