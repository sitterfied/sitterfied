...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sitter.other_services'
        db.delete_column(u'app_sitter', 'other_services')

        # Adding M2M table for field other_services on 'Sitter'
        db.create_table(u'app_sitter_other_services', (
        ...
        db.create_unique(u'app_sitter_other_services', ['sitter_id', 'otherservice_id'])


    def backwards(self, orm):
        # Adding field 'Sitter.other_services'
        db.add_column(u'app_sitter', 'other_services',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Removing M2M table for field other_services on 'Sitter'
        db.delete_table('app_sitter_other_services')
    ...
    models = {
        ...
        u'app.sitter': {
            ...
            'other_services': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['app.OtherService']", 'symmetrical': 'False'}),
