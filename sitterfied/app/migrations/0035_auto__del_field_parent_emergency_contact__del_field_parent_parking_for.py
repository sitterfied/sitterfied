...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Parent.emergency_contact'
        db.delete_column(u'app_parent', 'emergency_contact_id')

        # Deleting field 'Parent.parking_for_sitter'
        db.delete_column(u'app_parent', 'parking_for_sitter')

        # Deleting field 'Parent.physician_contact'
        db.delete_column(u'app_parent', 'physician_contact_id')

        # Deleting field 'Parent.parking_area'
        db.delete_column(u'app_parent', 'parking_area')

        # Adding field 'Parent.emergency_contact_one_name'
        db.add_column(u'app_parent', 'emergency_contact_one_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Adding field 'Parent.emergency_contact_one_phone'
        db.add_column(u'app_parent', 'emergency_contact_one_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Adding field 'Parent.emergency_contact_two_name'
        db.add_column(u'app_parent', 'emergency_contact_two_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)

        # Adding field 'Parent.emergency_contact_two_phone'
        db.add_column(u'app_parent', 'emergency_contact_two_phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Parent.emergency_contact'
        db.add_column(u'app_parent', 'emergency_contact',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='emergencies', unique=True, null=True, to=orm['app.Contact'], blank=True),
                      keep_default=False)

        # Adding field 'Parent.parking_for_sitter'
        db.add_column(u'app_parent', 'parking_for_sitter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Parent.physician_contact'
        db.add_column(u'app_parent', 'physician_contact',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='physicians', unique=True, null=True, to=orm['app.Contact'], blank=True),
                      keep_default=False)

        # Adding field 'Parent.parking_area'
        db.add_column(u'app_parent', 'parking_area',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Parent.emergency_contact_one_name'
        db.delete_column(u'app_parent', 'emergency_contact_one_name')

        # Deleting field 'Parent.emergency_contact_one_phone'
        db.delete_column(u'app_parent', 'emergency_contact_one_phone')

        # Deleting field 'Parent.emergency_contact_two_name'
        db.delete_column(u'app_parent', 'emergency_contact_two_name')

        # Deleting field 'Parent.emergency_contact_two_phone'
        db.delete_column(u'app_parent', 'emergency_contact_two_phone')
