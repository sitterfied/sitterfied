...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Booking.num_children'
        db.add_column(u'app_booking', 'num_children',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Booking.address1'
        db.add_column(u'app_booking', 'address1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Booking.address2'
        db.add_column(u'app_booking', 'address2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Booking.city'
        db.add_column(u'app_booking', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Booking.state'
        db.add_column(u'app_booking', 'state',
                      self.gf('django_localflavor_us.models.USStateField')(default='AZ', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'Booking.zip'
        db.add_column(u'app_booking', 'zip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=9, blank=True),
                      keep_default=False)

        # Removing M2M table for field child on 'Booking'
        db.delete_table(db.shorten_name(u'app_booking_child'))


        # Renaming column for 'Booking.emergency_phone' to match new field type.
        db.rename_column(u'app_booking', 'emergency_phone_id', 'emergency_phone')
        # Changing field 'Booking.emergency_phone'
        db.alter_column(u'app_booking', 'emergency_phone', self.gf('django.db.models.fields.CharField')(default='', max_length=10))
        # Removing index on 'Booking', fields ['emergency_phone']
        db.delete_index(u'app_booking', ['emergency_phone_id'])


    def backwards(self, orm):
        # Adding index on 'Booking', fields ['emergency_phone']
        db.create_index(u'app_booking', ['emergency_phone_id'])

        # Deleting field 'Booking.num_children'
        db.delete_column(u'app_booking', 'num_children')

        # Deleting field 'Booking.address1'
        db.delete_column(u'app_booking', 'address1')

        # Deleting field 'Booking.address2'
        db.delete_column(u'app_booking', 'address2')

        # Deleting field 'Booking.city'
        db.delete_column(u'app_booking', 'city')

        # Deleting field 'Booking.state'
        db.delete_column(u'app_booking', 'state')

        # Deleting field 'Booking.zip'
        db.delete_column(u'app_booking', 'zip')

        # Adding M2M table for field child on 'Booking'
        m2m_table_name = db.shorten_name(u'app_booking_child')
        ...
        db.create_unique(m2m_table_name, ['booking_id', 'child_id'])


        # Renaming column for 'Booking.emergency_phone' to match new field type.
        db.rename_column(u'app_booking', 'emergency_phone', 'emergency_phone_id')
        # Changing field 'Booking.emergency_phone'
        db.alter_column(u'app_booking', 'emergency_phone_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Phone'], null=True))
    ...
    models = {
        ...
        u'app.booking': {
            ...
            'num_children': ('django.db.models.fields.IntegerField', [], {}),
