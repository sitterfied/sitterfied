...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sitter.special_needs_exp'
        db.add_column(u'app_sitter', 'special_needs_exp',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Sitter.extra_exp'
        db.add_column(u'app_sitter', 'extra_exp',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sitter.special_needs_exp'
        db.delete_column(u'app_sitter', 'special_needs_exp')

        # Deleting field 'Sitter.extra_exp'
        db.delete_column(u'app_sitter', 'extra_exp')
