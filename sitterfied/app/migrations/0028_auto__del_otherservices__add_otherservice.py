...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'OtherServices'
        db.delete_table(u'app_otherservices')
    ...
    def backwards(self, orm):
        # Adding model 'OtherServices'
        db.create_table(u'app_otherservices', (
            ('service', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'app', ['OtherServices'])
