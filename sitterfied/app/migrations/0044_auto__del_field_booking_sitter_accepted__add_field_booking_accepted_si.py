...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Booking.accepted_sitter'
        db.add_column(u'app_booking', 'accepted_sitter',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Sitter'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Booking.canceled'
        db.add_column(u'app_booking', 'canceled',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Booking.accepted_sitter'
        db.delete_column(u'app_booking', 'accepted_sitter_id')

        # Deleting field 'Booking.canceled'
        db.delete_column(u'app_booking', 'canceled')
