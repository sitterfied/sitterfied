...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'app_promocode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('promo_type', self.gf('django.db.models.fields.CharField')(default='Percent', max_length=10)),
        ...
        db.send_create_signal(u'app', ['PromoCode'])

        # Adding field 'Booking.promo_code'
        db.add_column(u'app_booking', 'promo_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.PromoCode'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)

        # Adding field 'Parent.promo_code'
        db.add_column(u'app_parent', 'promo_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.PromoCode'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'app_promocode')

        # Deleting field 'Booking.promo_code'
        db.delete_column(u'app_booking', 'promo_code_id')

        # Deleting field 'Parent.promo_code'
        db.delete_column(u'app_parent', 'promo_code_id')
    ...
    models = {
        ...
        u'app.booking': {
            ...
            'promo_code': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['app.PromoCode']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
        ...
        u'app.parent': {
            ...
            'default_payment_method_token': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
        ...
        u'app.promocode': {
            ...
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'promo_type': ('django.db.models.fields.CharField', [], {'default': "'Percent'", 'max_length': '10'}),
            'start_date_time': ('django.db.models.fields.DateTimeField', [], {}),
            'stop_date_time': ('django.db.models.fields.DateTimeField', [], {}),
