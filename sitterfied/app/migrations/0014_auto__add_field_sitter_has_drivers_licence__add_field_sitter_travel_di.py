...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sitter.has_drivers_licence'
        db.add_column(u'app_sitter', 'has_drivers_licence',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Sitter.travel_distance'
        db.add_column(u'app_sitter', 'travel_distance',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sitter.has_drivers_licence'
        db.delete_column(u'app_sitter', 'has_drivers_licence')

        # Deleting field 'Sitter.travel_distance'
        db.delete_column(u'app_sitter', 'travel_distance')
