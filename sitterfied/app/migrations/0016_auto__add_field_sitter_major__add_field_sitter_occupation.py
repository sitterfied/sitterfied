...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sitter.major'
        db.add_column(u'app_sitter', 'major',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Sitter.occupation'
        db.add_column(u'app_sitter', 'occupation',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sitter.major'
        db.delete_column(u'app_sitter', 'major')

        # Deleting field 'Sitter.occupation'
        db.delete_column(u'app_sitter', 'occupation')
