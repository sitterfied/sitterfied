...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.google_imported'
        db.add_column(u'app_user', 'google_imported',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.google_imported'
        db.delete_column(u'app_user', 'google_imported')
