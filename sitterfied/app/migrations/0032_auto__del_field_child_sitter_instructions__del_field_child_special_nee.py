...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Child.sitter_instructions'
        db.delete_column(u'app_child', 'sitter_instructions')

        # Deleting field 'Child.special_needs'
        db.delete_column(u'app_child', 'special_needs')

        # Adding M2M table for field special_needs on 'Child'
        db.create_table(u'app_child_special_needs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('child', models.ForeignKey(orm[u'app.child'], null=False)),
            ('specialneeds', models.ForeignKey(orm[u'app.specialneeds'], null=False))
        ))
        db.create_unique(u'app_child_special_needs', ['child_id', 'specialneeds_id'])


        # Changing field 'Child.dob'
        db.alter_column(u'app_child', 'dob', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Adding field 'Child.sitter_instructions'
        db.add_column(u'app_child', 'sitter_instructions',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Child.special_needs'
        db.add_column(u'app_child', 'special_needs',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Removing M2M table for field special_needs on 'Child'
        db.delete_table('app_child_special_needs')


        # User chose to not deal with backwards NULL issues for 'Child.dob'
        raise RuntimeError("Cannot reverse this migration. 'Child.dob' and its values cannot be restored.")
    ...
    models = {
        ...
        u'app.child': {
            ...
            'allergies': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            ...
            'special_needs': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['app.SpecialNeeds']", 'symmetrical': 'False', 'blank': 'True'})
        },
        u'app.contact': {
