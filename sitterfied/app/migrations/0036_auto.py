...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'app_parent_fave_sitters'))

        # Adding M2M table for field sitter_team on 'Parent'
        m2m_table_name = db.shorten_name(u'app_parent_sitter_team')
    ...
    def backwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'app_parent_fave_sitters')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('parent', models.ForeignKey(orm[u'app.parent'], null=False)),
            ('sitter', models.ForeignKey(orm[u'app.sitter'], null=False))
        ...
        # Removing M2M table for field sitter_team on 'Parent'
        db.delete_table(db.shorten_name(u'app_parent_sitter_team'))
    ...
    models = {
        ...
        u'app.parent': {
            ...
            'sitter_team': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'sitter_teams'", 'blank': 'True', 'to': u"orm['app.Sitter']"}),
