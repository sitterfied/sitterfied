...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GeneralAvail.sitter'
        db.add_column(u'app_generalavail', 'sitter',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['app.Sitter'], unique=True),
                      keep_default=False)

        # Deleting field 'Sitter.general_avail'
        db.delete_column(u'app_sitter', 'general_avail_id')


    def backwards(self, orm):
        # Deleting field 'GeneralAvail.sitter'
        db.delete_column(u'app_generalavail', 'sitter_id')


        # User chose to not deal with backwards NULL issues for 'Sitter.general_avail'
        raise RuntimeError("Cannot reverse this migration. 'Sitter.general_avail' and its values cannot be restored.")
