...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Certification', fields ['certification']
        db.create_unique(u'app_certification', ['certification'])


    def backwards(self, orm):
        # Removing unique constraint on 'Certification', fields ['certification']
        db.delete_unique(u'app_certification', ['certification'])
