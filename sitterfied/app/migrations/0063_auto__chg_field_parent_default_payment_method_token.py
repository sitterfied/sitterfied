...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Parent.default_payment_method_token'
        db.alter_column(u'app_parent', 'default_payment_method_token', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Parent.default_payment_method_token'
        db.alter_column(u'app_parent', 'default_payment_method_token', self.gf('django.db.models.fields.CharField')(default='', max_length=20))
