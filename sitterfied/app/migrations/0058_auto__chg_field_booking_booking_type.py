...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Booking.booking_type'
        db.alter_column(u'app_booking', 'booking_type', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Booking.booking_type'
        db.alter_column(u'app_booking', 'booking_type', self.gf('django.db.models.fields.CharField')(max_length=10))
