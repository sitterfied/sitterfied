define(['ember'], function(Ember){define(['ember'], function(Ember){define(['ember'], function(Ember){define(['ember'], function(Ember){Ember.TEMPLATES["signup"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
