...
function program15(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers['if'].call(depth0, "hideBioLink", {hash:{},inverse:self.noop,fn:self.program(10, program10, data),contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  hashContexts = {'target': depth0};
  hashTypes = {'target': "STRING"};
  ...
  data.buffer.push(">Read More</a></span>\n	<div class=\"full_desc\">\n      ");
  hashTypes = {};
  hashContexts = {};
